...
ONNX_OPERATOR_KERNEL_EX(Hole, kMSDomain, 1, kCudaExecutionProvider,
                        KernelDefBuilder().TypeConstraint("T", DataTypeImpl::AllFixedSizeTensorTypes()), Hole);

// Yield executes at the end of the forward pass
...
Status Hole::ComputeInternal(OpKernelContext* ctx) const {
