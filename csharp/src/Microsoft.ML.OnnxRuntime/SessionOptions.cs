...
namespace Microsoft.ML.OnnxRuntime
{
    ...
    public class SessionOptions : SafeHandle
    {
        ...
        /// Use only if CUDA/TensorRT is installed and you have the onnxruntime package specific to this Execution Provider.
        /// </summary>
        /// <returns>A SessionsOptions() object configured for execution on deviceId=0</returns>
        public static SessionOptions MakeSessionOptionWithTensorrtProvider()
        {
            return MakeSessionOptionWithTensorrtProvider(0);
        }
